        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {filtered.map((project, i) => (
            <a
              ...
              className="group bg-white rounded-2xl p-6 shadow-sm border border-ice-100 card-hover flex flex-col"
            >
              <div className="flex items-start justify-between mb-3">
                ...
                <svg
                  className="w-4 h-4 text-dark-700/30 group-hover:text-gojo-500 transition-colors"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <div className="mt-4 flex items-center gap-2 text-xs text-dark-700/40">
                <svg
                  className="w-4 h-4"
                  fill="currentColor"
                  viewBox="0 0 24 24"
